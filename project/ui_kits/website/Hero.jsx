...
const Hero = ({ onNav }) => (
  <section className="hero">
    ...
    <div className="hero__meta">
      <div className="hero__meta-item"><div className="num">2016</div><div className="lbl">Gegründet in Köln</div></div>
      <div className="hero__meta-item"><div className="num">~80</div><div className="lbl">Klient:innen</div></div>
      <div className="hero__meta-item"><div className="num">16</div><div className="lbl">Mitarbeiter:innen</div></div>
      <div className="hero__meta-item"><div className="num">2</div><div className="lbl">Teams · Ost / West</div></div>
    </div>
  </section>
);
window.Hero = Hero;
