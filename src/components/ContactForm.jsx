...
export function ContactForm() {
  const [state, setState] = useState({ name: '', email: '', role: 'klient', thema: '', text: '' })
      ...
      <div className="section__inner" style={{ maxWidth: 760 }}>
        <div className="section__head">
          ...
          <p className="section__lead">
            ...
            Lieber telefonisch?{' '}
            <a href="tel:02212949 2916">0221&nbsp;29&nbsp;49&nbsp;29&nbsp;16</a>, Mo–Fr 9–17 Uhr.
          </p>
        </div>
        <form className="contact-form" onSubmit={submit}>
          ...
          <div className="full">
            ...
            <input
              ...
              value={state.thema}
              onChange={upd('thema')}
              placeholder="Stichwort, z. B. Erstgespräch"
            />
          </div>
          <div className="full">
        ...
        {sent && (
          <div className="toast">Danke — wir melden uns innerhalb von zwei Werktagen.</div>
        )}
      </div>
    </section>
  )
